  ...
  return (
    <>
      <div className="zoomedNote  overflow-y-scroll w-full h-full">
        <p onInput={handleOnChangeTitle} contentEditable suppressContentEditableWarning className="mb-3 font-['Calibri'] whitespace-pre-wrap outline-none text-lg font-semibold text-amber-700">
          {title}
        </p>
        <p onInput={handleOnChangeText} contentEditable suppressContentEditableWarning className="leading-relaxed whitespace-pre-wrap font-['Calibri'] overflow-x-hidden text-md mb-3 outline-none  text-slate-800">
          {textBody}
        </p>
