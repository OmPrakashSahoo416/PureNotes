...
function ZoomedNote({ title, textBody, imgUrl, docId, isPopUp, tasks,setListContent, setListChecked }) {
    ...
    <>
      <div className="zoomedNote overflow-y-scroll w-full h-full">
        <p
          ...
          className="mb-3 font-['Calibri'] border-[1px] hover:border-amber-800 rounded-md focus:border-[1px] focus:border-slate-900 p-1 whitespace-pre-wrap outline-none text-lg font-semibold text-amber-700"
        >
          {title}
        </p>
        <p
          ...
          contentEditable
          suppressContentEditableWarning
          className="leading-relaxed border-[1px] hover:border-amber-800 rounded-md whitespace-pre-wrap focus:border-[1px] focus:border-slate-900 p-1 font-['Calibri'] overflow-x-hidden text-md mb-3 outline-none  text-slate-800"
        >
          {textBody}
        </p>
        {/* TASKS LIST */}
